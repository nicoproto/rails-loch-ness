...
ActiveRecord::Schema.define(version: 2019_10_14_041056) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.index ["monster_id"], name: "index_conversations_on_monster_id"
  ...
  add_foreign_key "conversations", "monsters"
