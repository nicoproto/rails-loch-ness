...
monster1 = Monster.create(
  ...
  name: 'Meduphon',
  user: nico,
  photo: 'https://cdn2us.denofgeek.com/sites/denofgeekus/files/styles/main_wide/public/2016/05/creature_from_the_black_lagoon_franchise_retrospective.jpg?itok=oow2GS2l'
)
monster2 = Monster.create(
  ...
  name: 'Typhon',
  user: nico,
  photo: 'https://images.unsplash.com/photo-1509248961158-e54f6934749c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1922&q=80'
)
monster3 = Monster.create(
  ...
  name: 'Medusa',
  user: nico,
  photo: 'https://vignette.wikia.nocookie.net/movie-monster/images/e/e3/GiantBehemoth.png/revision/latest?cb=20180606174201'
)
monster4 = Monster.create(
  ...
  name: 'The Minotaur',
  user: nico,
  photo: 'https://www.irishexaminer.com/remote/media.central.ie/media/images/a/AMonsterCallsScreenshot_large.jpg')
...
monster6 = Monster.create(
  ...
  name: 'Charybdis',
  user: nico,
  photo: 'https://media.npr.org/assets/img/2012/10/10/1750_bw_00011ad_wide-c577aaf6b246d5688d05ff05c81e2c157c568290-s800-c85.jpg')
monster7 = Monster.create(
  ...
  name: 'Hydra',
  user: sy,
  photo: 'http://cdn.collider.com/wp-content/uploads/2017/06/godzilla-1954.jpg')
monster8 = Monster.create(
  ...
  name: 'Empusa',
  user: sy,
  photo: 'https://i1.wp.com/faroutmagazine.co.uk/wp-content/uploads/2019/07/Godzilla-1954.jpeg?w=1200&ssl=1')
monster9 = Monster.create(
  ...
  name: 'Chimera',
  user: sy,
  photo: 'https://i0.wp.com/bloody-disgusting.com/wp-content/uploads/2019/02/dream.jpg?ssl=1')
monster10 = Monster.create(
  ...
  name: 'Cyclops',
  user: sy,
  photo: 'http://getwallpapers.com/wallpaper/full/b/6/a/500920.jpg')
monster11 = Monster.create(
  ...
  name: 'Sphinx',
  user: sy,
  photo: 'https://gallery.mailchimp.com/e0f5618a41f76b17c22005aec/images/cy.gif')
